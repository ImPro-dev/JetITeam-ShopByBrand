...
use JetITeam\ShopByBrand\Api\BrandRepositoryInterface;
...
use JetITeam\ShopByBrand\Model\ResourceModel\Brand as ResourceBrand;
...
class BrandRepository implements  BrandRepositoryInterface
{
     ...
     */
    public function save(\JetITeam\ShopByBrand\Api\Data\BrandInterface $brand)
    {
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $brandModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $brandData,
                $brandModel->getData(),
                'JetITeam\ShopByBrand\Api\Data\BrandInterface'
            );
     ...
     */
    public function delete(\JetITeam\ShopByBrand\Api\Data\BrandInterface $brand)
    {
        try {
