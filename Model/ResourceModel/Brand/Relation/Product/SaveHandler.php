...
namespace JetITeam\ShopByBrand\Model\ResourceModel\Brand\Relation\Product;
 ...
 * Class SaveHandler
 *
 * @package JetITeam\ShopByBrand\Model\ResourceModel\Brand\Relation\Product
 */
class SaveHandler implements ExtensionInterface
{
    ...
    protected function _assignProductsToBrand($entity)
    {
        ...
        $brandProductTable = $this->_resourceBrand->getTable('jteam_brand_product');
