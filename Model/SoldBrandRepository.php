...
namespace JetITeam\ShopByBrand\Model;

use JetITeam\ShopByBrand\Api\Data;
use JetITeam\ShopByBrand\Api\SoldBrandRepositoryInterface;
...
use JetITeam\ShopByBrand\Model\ResourceModel\SoldBrand as ResourceSoldBrand;
use JetITeam\ShopByBrand\Model\ResourceModel\SoldBrand\CollectionFactory as SoldBrandCollectionFactory;
...
class SoldBrandRepository implements  SoldBrandRepositoryInterface
{
     ...
     */
    public function save(\JetITeam\ShopByBrand\Api\Data\SoldBrandInterface $soldBrand)
    {
        try {
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $soldBrandModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                ...
                'JetITeam\ShopByBrand\Api\Data\SoldBrandInterface'
            );
     ...
     */
    public function delete(\JetITeam\ShopByBrand\Api\Data\SoldBrandInterface $soldBrand)
    {
        try {
