...
use JetITeam\ShopByBrand\Model\ResourceModel\Brand\CollectionFactory;
use JetITeam\ShopByBrand\Model\BrandRepository;
 ...
 * Mass status action.
 *
 * @package JetITeam\ShopByBrand\Controller\Adminhtml\Index
 */
abstract class MassStatus extends Action
{
    const ADMIN_RESOURCE = 'JetITeam_ShopByBrand::brand_save';
    ...
    public function execute()
    {
        ...
        foreach ($collection as $brand) {
            /** @var $brand \JetITeam\ShopByBrand\Api\Data\BrandInterface */
